				...
				<table class="shopping-cart-table table" id="listTable">
					...
					<tbody>
						...
						<tr>
							...
							<td class="price text-center"><c:out value="${vo.unitPrice}"/></td>
							<td class="price text-center"><c:out value="${vo.quantity}"/></td>
							<td class="total text-center">
							<input type="checkbox" id="checkCart" name="checkCart" value="check"/>
							</td>
							<td class="total text-center">
