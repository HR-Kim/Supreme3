...
<body>
												...
												<div class="product-thumb">
													<div class="product-label">
														...
														<span class="sale"><c:out
																value="${vo.sale_percent}" /> % </span>
													</div>
													<button class="main-btn quick-view detail"
														title="<c:out value='${vo.p_code}'/>">
														<i class="fa fa-search-plus"></i>자세히 보기
													</button>
													<img src="${context}/resources" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-price">
														<c:out value="${vo.p_price}" />
														원
													</h3>
	...
	<form class="form-horizontal" name="productFrm" id="productFrm"
		method="post">
