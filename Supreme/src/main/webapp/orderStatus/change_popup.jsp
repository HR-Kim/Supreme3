	...
	<div class="col-md-12">
			<div class="order-summary clearfix">
				...
				<tr>
					...
					<input type="checkbox" name="checkOrder" value="check"> 상기 내용을 모두 확인하였습니다.
				</tr>

				</div>
				</div>
				<div class="pull-right">
					<button class="primary-btn" name="changeBtn" id="changeBtn" >교환신청</button>
				</div>
			</div>
		</div>
	</div>
